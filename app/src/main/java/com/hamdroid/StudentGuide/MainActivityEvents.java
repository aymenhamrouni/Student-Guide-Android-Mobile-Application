...
public class MainActivityEvents extends ActionBarActivity {
    ...
    private final String LOG_TAG = MainActivityEvents.class.getSimpleName();
    ...
    protected void onStart() {
        ...
        if (!loginRequired()) {
            ...
            etPassword.setText(getIntent().getExtras().getString("pass"));
        ...
        protected void onPostExecute(String jsonResponse) {
            if (jsonResponse != null) {
                try {
                    ...
                    if (user != null) {
                        Toast.makeText(MainActivityEvents.this, "Logged in Successfully!", Toast.LENGTH_LONG)
                                .show();
                        Log.v(LOG_TAG, "Parsed Login json: " + user.toString());

                        // set API_KEY in preferences
                        PreferencesManager prefManager = new PreferencesManager(MainActivityEvents.this, null);
                        prefManager.setApiKey(user.getApiKey());
                        prefManager.setUserId(Integer.toString(user.getId()));

                        // redirect to HomeActivity
                        startActivity(new Intent(MainActivityEvents.this, HomeActivity.class));
                        finish();
                    }
                    else {
                        // parsing failed
                    ...
                    Toast.makeText(MainActivityEvents.this, e.getMessage(),
